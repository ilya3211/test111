...
class Wpshop_Widget_Subscribe extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        echo '<p>';
        echo __( 'You can read how to customize the subscription form here', THEME_TEXTDOMAIN ) . ' <a href="https://support.wpshop.ru/faq/display-subscription-form/" target="_blank" rel="noopener" class="cook-it-ico-help" title="' . __( 'Help', THEME_TEXTDOMAIN ) . '">?</a>';
        echo '</p>';
        echo '<p>';
