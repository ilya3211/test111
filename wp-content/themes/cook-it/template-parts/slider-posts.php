        ...
        <div class="card-slider-container swiper-container js-swiper-home">
            <div class="swiper-wrapper">
                ...
                foreach ( $slider_articles as $post ) {
                    setup_postdata( $post );
                    $slider_thumbnails[] = [
                        'image' => get_the_post_thumbnail_url( $post, apply_filters( THEME_SLUG . '_slider_thumbnail_size', THEME_SLUG . '_small' ) ),
                        'title' => get_the_title( $post->ID ),
                    ];
                    get_template_part( 'template-parts/posts/content', 'slider' );
                }
                wp_reset_postdata();
                ?>
