...
$post_card_type = 'square';
$post_card_thumb_size = apply_filters( THEME_SLUG . '_post_card_' . $post_card_type . '_thumbnail_size', 'thumb-small' );
...
$post_card_classes    = [ 'content-card--square' ];
        ...
        echo '<div class="content-card__body">';
            ...
            foreach ( $post_card_order as $order ) {
                ...
                if ( 'post' === get_post_type() && $order == 'category' && $post_card->is_show_element( 'category' ) ) {
                    echo '<div class="content-card__category">' . $wpshop_template->get_category() . '</div>';
                }
            }
