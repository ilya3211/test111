...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) : ?>
		<div class="comments-title"><?php echo apply_filters( THEME_SLUG . '_comments_title', __( 'Comments number', THEME_TEXTDOMAIN ) ) ?>: <?php echo get_comments_number() ?></div>
	...
	if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
		...
		<p class="no-comments">
            <?php echo apply_filters( THEME_SLUG . '_comments_no_comments_title', __( 'Comments are closed.', THEME_TEXTDOMAIN ) ); ?>
        </p>
	<?php
	endif;
